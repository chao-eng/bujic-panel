...
export default function TabManageModal({ isOpen, onClose, tabs, onRefresh }: TabManageModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent aria-describedby={undefined} className="sm:max-w-[540px] bg-[#12131a]/95 border border-white/5 text-white/90 rounded-2xl backdrop-blur-xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
